...
> Gerçek ekran görüntülerini aldığınızda `docs/screenshots/` klasöründeki `.svg` dosyalarını `.png` ile değiştirin.

### Personel Paneli

| Dashboard | Masalar | Siparişler |
|:---------:|:-------:|:----------:|
| ![Dashboard](./docs/screenshots/dashboard.svg) | ![Masalar](./docs/screenshots/tables.svg) | ![Siparişler](./docs/screenshots/orders.svg) |

| Mutfak | Menü | Raporlar |
|:------:|:----:|:--------:|
| ![Mutfak](./docs/screenshots/kitchen.svg) | ![Menü](./docs/screenshots/menu.svg) | ![Raporlar](./docs/screenshots/analytics.svg) |

### Müşteri Paneli

| QR Giriş | Menü | Sipariş Takibi |
|:--------:|:----:|:--------------:|
| ![Müşteri Giriş](./docs/screenshots/customer-login.svg) | ![Müşteri Menü](./docs/screenshots/customer-menu.svg) | ![Sipariş Takibi](./docs/screenshots/customer-orders.svg) |
